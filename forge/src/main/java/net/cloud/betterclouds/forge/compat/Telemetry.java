...
public class Telemetry implements ITelemetry {
    ...
    public static final class RequestBody {
        ...
        public RequestBody(SystemDetails systemDetails, List<String> labels, String payload, String modVersion,
            ...
            if(includeMods) {
                this.mods = ModList.get().getMods().stream()
        ...
        private static boolean isNotCommon(IModInfo mod) {
        ...
        public static final class MetaInfo {
            ...
            public MetaInfo(String modVersion) {
